...
def first_pass_simple_dict(
    ...
    def result():
        ...
        result_table = auxiliary_table
        return (None, symbol_table, errors) if errors else (result_table, symbol_table, [])
    ...
    for line_num, line in enumerate(parsed_lines, 1):
        ...
        if mnemonic == "START":
            ...
            if location_counter == 0:
                lineErr("Нулевой адрес загрузки в абсолютном формате")
            if not line.label:
