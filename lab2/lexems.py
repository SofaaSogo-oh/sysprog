...
class Operand:
    ...
    def resolve_value(self, symbol_table=None, idr=0):
...
class Identifier(Operand):
    ...
    def resolve_value(self, symbol_table=None, idr=0):
        if symbol_table and self.data in symbol_table:
...
class RelativeIdentifier(Operand):
    ...
    def resolve_value(self, symbol_table, idr):
        if symbol_table and self.data in symbol_table:
            dlta = symbol_table[self.data] - idr
            adlta = abs(dlta)
...
class Number(Operand):
    ...
    def resolve_value(self, symbol_table=None, idr=None):
        return self.value
